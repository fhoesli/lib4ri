...
/**
 * @file
 * Custom changes to the default object view for journal content model types.
 *
...
// Check if the object is a journal object.
$journal_object = in_array("lib4ri:journalCModel", $variables['islandora_object']->models);
?>
<div class="islandora-object islandora">

  <?php if (!$journal_object): ?>
  ...
  <div class="islandora-default-metadata">
    ...
    if (!$journal_object) {
        ...
        // Remove "Details" legend tag for Journal Objects.
        $metadata = str_replace('<legend><span class="fieldset-legend">Details</span></legend>', "", $metadata);
      }
      print $metadata;
    ?>
  </div>
